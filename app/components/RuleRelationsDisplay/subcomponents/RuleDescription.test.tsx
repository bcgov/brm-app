...
describe("RuleDescription", () => {
  ...
  describe("App Link Behavior", () => {
    ...
    test("opens correct app URL when clicked", () => {
      ...
      expect(window.open).toHaveBeenCalledWith(expect.stringContaining("/rule/test-rule"));
    });
  });
  ...
  describe("Error Handling", () => {
    test("shows error message when clicking unpublished Klamm link", () => {
      const mockMessage = { error: jest.fn() };
      window.message = mockMessage;
