...
describe("ScenarioGenerator", () => {
  ...
  describe("Simulation Actions", () => {
    ...
    test("updates simulation context when formatter changes", () => {
      render(<ScenarioGenerator {...mockProps} />);
      const updateButton = screen.getByText("Update Data");

      fireEvent.click(updateButton);
      expect(mockProps.setSimulationContext).toHaveBeenCalledWith(expect.objectContaining({ updated: true }));
    });
  });

  describe("Scenario Management", () => {
    test("allows saving new scenario", async () => {
      render(<ScenarioGenerator {...mockProps} />);
      ...
      await waitFor(() => {
        expect(createScenario).toHaveBeenCalledWith(
          expect.objectContaining({
            title: mockProps.scenarioName,
            ruleID: mockProps.ruleId,
  ...
  describe("Reset Behavior", () => {
    test("resets state when resetTrigger changes", () => {
